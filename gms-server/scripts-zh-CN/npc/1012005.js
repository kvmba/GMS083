    ...
    if (mode == -1) {
        ...
        if (status == -1) {
            ...
            if (selection == 0) {
                ...
                cm.sendNext("这些是#r小白虎#k的指令。指令旁边提到的等级显示了宠物需要的等级才能回应。\r\n#b坐下#k (等级 1 ~ 30)\r\n#b坏孩子, 不行, 坏男孩, 坏女孩#k (等级 1 ~ 30)\r\n#b我爱你#k (等级 1 ~ 30)\r\n#b拉屎#k (等级 1 ~ 30)\r\n#b休息, 放松#k (等级 1 ~ 30)\r\n#b笨蛋, 我讨厌你, 笨蛋#k (等级 1 ~ 30)\r\n#b说话, 聊天, 说#k (等级 10 ~ 30)\r\n#b悲伤, 伤心#k (等级 10 ~ 30)\r\n#b等待#k (等级 20 ~ 30)");
            } else if (selection == 15) {
                cm.sendNext("这些是 #r小企企#k 的指令。指令旁边提到的等级是宠物需要达到的等级才能执行该指令。\r\n#b坐#k (等级 1 ~ 30)\r\n#b坏, 不行, 坏孩子, 坏女孩#k (等级 1 ~ 30)\r\n#b拉屎#k (等级 1 ~ 30)\r\n#b站起来, 站, 起来#k (等级 1 ~ 30)\r\n#b我爱你#k (等级 1 ~ 30)\r\n#b说话, 聊天, 说#k (等级 10 ~ 30)\r\n#b拥抱, 抱抱我#k (等级 10 ~ 30)\r\n#b挥动, 举手#k (等级 10 ~ 30)\r\n#b睡觉#k (等级 20 ~ 30)\r\n#b亲吻, 亲亲, 亲一个#k (等级 20 ~ 30)\r\n#b飞#k (等级 20 ~ 30)\r\n#b可爱, 可爱的#k (等级 20 ~ 30)");
            } else if (selection == 16) {
                cm.sendNext("这些是 #r小金猪#k 的指令。指令旁边提到的等级显示了宠物需要的等级才能响应。\r\n#b坐下#k (等级 1 ~ 30)\r\n#b坏孩子, 不行, 坏蛋, 坏女孩#k (等级 1 ~ 30)\r\n#b拉屎#k (等级 1 ~ 30)\r\n#b我爱你#k (等级 1 ~ 30)\r\n#b说话, 聊天, 说#k (等级 11 ~ 30)\r\n#b爱我, 拥抱我#k (等级 11 ~ 30)\r\n#b睡觉, 困了, 去睡觉#k (等级 21 ~ 30)\r\n#b无视 / 印象深刻 / 离开#k (等级 21 ~ 30)\r\n#b翻滚, 给我钱#k (等级 21 ~ 30)");
