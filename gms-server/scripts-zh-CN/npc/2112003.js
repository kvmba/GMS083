        ...
        if (cm.getMapId() != 261000021) {
            ...
            if (status == 0) {
                ...
                if (selection == 0) {
                    ...
                    cm.sendOk("不久前，一位名叫尤利特的科学家因为他对阿尔卡德诺和泽努米斯特的合成炼金术的研究而被这个城镇放逐。由于这种组合所带来的巨大力量，根据法律是禁止研究的。然而，他无视了这项法律，同时进行了这两项研究。结果，他被流放了。\r\n他现在在报复，已经带走了我心爱的人，下一个目标是我，因为我们是玛加提亚的重要人物，是这两个社会的继承者。但我不害怕。我们必须不惜一切代价把他救回来！");
                    cm.dispose();
                }
            }
        }
