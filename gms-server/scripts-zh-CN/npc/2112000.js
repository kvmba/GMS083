            ...
            if (status == 0) {
                if (eim.isEventCleared()) {
                    ...
                    if (state == -1) {
                        ...
                        cm.sendOk("你们真是一群讨厌的家伙，哎。好吧，我向你们展示我的最新武器，由最优秀的炼金术带来，#r弗兰肯罗#k。");
                        eim.dropMessage(5, "尤利特：我要展示我最新研制的武器，用最精湛的炼金术打造的弗兰肯罗！");
                        ...
                        cm.sendOk("你们这些家伙真是让人头疼，哎。好吧，我向你们展示我的最新武器，由阿尔卡德诺和泽努米斯特最精湛的炼金术结合而成，那些令马加提亚社会中无聊的人们禁止携带的东西，#rmighty Frankenroid#k！");
                        eim.dropMessage(5, "尤利特：我要展示我最新研制的武器，它融合了阿尔卡德诺与泽努米斯特两大派系的最高炼金术，那些无聊的玛加提亚人早已将其列为禁忌，强大的弗兰肯罗诞生了！！");
